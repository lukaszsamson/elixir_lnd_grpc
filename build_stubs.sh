...
protoc $PROTOC_ARGS --proto_path=lnd/lnrpc lnd/lnrpc/neutrinorpc/neutrino.proto
protoc $PROTOC_ARGS --proto_path=lnd/lnrpc lnd/lnrpc/peersrpc/peers.proto
...
protoc $PROTOC_ARGS --proto_path=lnd/lnrpc lnd/lnrpc/lightning.proto
protoc $PROTOC_ARGS --proto_path=lnd/lnrpc lnd/lnrpc/stateservice.proto
